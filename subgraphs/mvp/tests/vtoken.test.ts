...
test('erc20 transfer', () => {
  ...
  let toParam = new ethereum.EventParam(
    'to',
    ethereum.Value.fromAddress(Address.fromString('0x0123456789123456789123456789123456789aaa')),
  );
...
test('vToken transfer', () => {
  ...
  fromParam = new ethereum.EventParam(
    'from',
    ethereum.Value.fromAddress(Address.fromString('0x123456789ABCDEF123456789ABCDEF123456789B')),
  );
  vtokenTransfer.parameters.push(fromParam);
...
test('vToken update deposit', () => {
  ...
  let depositedParam = new ethereum.EventParam(
    'depositedAmount',
